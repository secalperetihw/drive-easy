...
class What_is_Authorization extends StatelessWidget {
  Function onpress;
  double? width;
  double? height;
  String? text;
    ...
    return Container(
      ...
      child: ListView(children: [
        ...
        Container(
          ...
          child: ExternalLink(context: context, url: "https://www.okta.com/identity-101/authentication-vs-authorization/")
        ),
